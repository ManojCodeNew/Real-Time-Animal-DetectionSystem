...
function App() {
  ...
  const handleFeedback = async (id, confirmed, correctSpecies = null, falsePositive = false) => {
    try {
      ...
      // Refresh console stats and recalculate forecasts
  ...
  // 1. Next Arrival Hero Banner calculation
  // Find predictions that are successful and sort by predicted arrival time
  ...
  // 2. 30-Hour Forecast Rail data generation
  const buildForecastRail = () => {
    ...
    for (let i = 1; i <= 30; i++) {
      ...
      // Check if any species has a predicted peak that matches this slot hour
  ...
  // Format detections for Pie chart
  const speciesCounts = {};
    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-header">
        <div className="header-titles">
          ...
          <p>Real-Time Edge Animal Intrusion Defense & Forecasting</p>
        </div>
